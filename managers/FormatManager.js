...
class FormatManager {
  constructor(TypingManager, DOMManager) {
    this.getStyle = () => {
      ...
      if (currentNode) {
        ...
        const detectStylesOnNode = (node) => {
          ...
          const blockType =
            (_a = currentNode.closest("[data-typeblox-id]")) === null ||
            _a === void 0
              ? void 0
              : _a.nodeName;
          ...
          if (!detectedStyles.fontFamily) {
            ...
            if (
              cleanFont &&
              constants_1.AVAILABLE_FONTS.map((f) => f.toLowerCase()).includes(
    ...
    this.clearFormat = (element) => {
      ...
      const mergeTextNodes = (element) => {
        ...
        while (child) {
          if (
            ...
            ((_a = child.nextSibling) === null || _a === void 0
              ? void 0
              : _a.nodeType) === Node.TEXT_NODE
          ) {
            if (!child.textContent) child.textContent = "";
            child.textContent += child.nextSibling.textContent;
            (_b = child.parentNode) === null || _b === void 0
              ? void 0
              : _b.removeChild(child.nextSibling);
      ...
      while (
        ((_b =
          (_a = targetElement.parentElement) === null || _a === void 0
            ? void 0
            : _a.textContent) === null || _b === void 0
          ? void 0
          : _b.trim()) ==
        ((_c = targetElement.textContent) === null || _c === void 0
          ? void 0
          : _c.trim())
      ) {
        targetElement =
  ...
  applyFormat(tagName, style) {
    ...
    if (
      !selectedElement ||
      ((_a = selectedElement.textContent) === null || _a === void 0
        ? void 0
        : _a.trim()) === ""
    ) {
      return;
    ...
    if (style && Object.keys(style).length > 0) {
      ...
      matchingParentStyle = selectedElement.closest(
        `${tagName}[style*=${styleKey}]`,
      );
      if (
        matchingParentStyle &&
        ((_b = matchingParentStyle.textContent) === null || _b === void 0
          ? void 0
          : _b.trim()) ===
          ((_c =
            selectedElement === null || selectedElement === void 0
              ? void 0
              : selectedElement.textContent) === null || _c === void 0
            ? void 0
            : _c.trim())
      ) {
  ...
  unapplyFormat(tagName, styleKey = null) {
    ...
    const isMatchingSelection =
      ((_a = selectedElement.textContent) === null || _a === void 0
        ...
        : _a.trim()) ===
      ((_b =
        matchingParent === null || matchingParent === void 0
          ? void 0
          : matchingParent.textContent) === null || _b === void 0
        ? void 0
        : _b.trim());
