 ...
 */
const FormatManager_1 = require("../FormatManager");
describe("FormatManager", () => {
    let formatManager;
    let mockTypingManager;
    let mockDOMManager;
    beforeEach(() => {
        // Mock TypingManager
        mockTypingManager = {
        ...
        formatManager = new FormatManager_1.FormatManager(mockTypingManager, mockDOMManager);
    });
    describe("applyFormat", () => {
        ...
        it("should not apply format if no selectedElement is found", () => {
            ...
            formatManager.applyFormat("b");
            expect(mockDOMManager.getBlockElement).toHaveBeenCalled();
            expect(mockTypingManager.getSelectedElement).toHaveBeenCalledWith(mockContentElement);
        });
    ...
    describe("unapplyFormat", () => {
        it("should not unapply format if no selectedElement is found", () => {
            ...
            expect(mockTypingManager.getSelectedElement).toHaveBeenCalledWith(document);
        });
    ...
    describe("clearFormat", () => {
      ...
      `;
        ...
        it("should handle cases with no selected element", () => {
            ...
            formatManager.clearFormat();
            expect(consoleWarnSpy).toHaveBeenCalledWith("No selected or cursor element found for clearing formatting.");
        });
