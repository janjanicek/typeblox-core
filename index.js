...
class Typeblox extends events_1.EventEmitter {
  ...
  constructor() {
    ...
    this.parseHTMLToBlocks = (htmlString) => {
      ...
      const structure = Array.from(doc.body.children).map((element) => {
        ...
        let block = new Blox_1.Blox({
          ...
          content:
            ((_a = element.innerHTML) === null || _a === void 0
              ? void 0
              : _a.trim()) || "",
        ...
        const blockSetting = Object.values(constants_1.BLOCKS_SETTINGS).find(
          ...
          block = new Blox_1.Blox({
            ...
            content:
              tagName === "img" // Special case for images
                ...
                : (_b = element.innerHTML) === null || _b === void 0
                  ? void 0
                  : _b.trim(),
            onUpdate: this.onChange,
            TypingManager: this.TypingManager,
      ...
      if (selection && selection.rangeCount > 0) {
        ...
        const editorElement =
          parentElement === null || parentElement === void 0
            ? void 0
            : parentElement.closest("[data-typeblox-editor]");
    ...
    this.handleUndo = () => {
      var _a;
      const previousState =
        (_a = this.HistoryManager) === null || _a === void 0
          ? void 0
          : _a.undo(this.getCurrentDom());
      if (previousState) {
    ...
    this.FormatManager = new FormatManager_1.FormatManager(
      this.TypingManager,
      this.DOMManager,
    );
    this.currentStyles = this.getSelectionStyle();
  ...
  updateCurrentStyles(block) {
    ...
    this.currentStyles = Object.assign(
      Object.assign({}, this.currentStyles),
      detectedStyles,
    );
  ...
  update(onChange, providedBlocks, calledFromEditor) {
    const newBlocks =
      providedBlocks !== null && providedBlocks !== void 0
        ? providedBlocks
        : this.blocks;
  ...
  getBlockById(id) {
    var _a;
    return (_a = this.blocks) === null || _a === void 0
      ? void 0
      : _a.find((block) => block.id === id);
  }
  ...
  getCurrentBlock() {
    ...
    if (currentBlockElement) {
      ...
      if (blockId) {
        return (_a = this.getBlockById(blockId)) !== null && _a !== void 0
          ? _a
          : null;
      }
    }
